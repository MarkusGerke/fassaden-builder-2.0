...
| Steuerung | Verhalten |
|---|---|
| Breite / Höhe / Position | Studio mit Modulverband: Laibungen an **Steinfugen**/Schichten (`openingPanelSnap.ts`); gestapelte Etagen mit unterschiedlichem Modul → gemeinsames kgV-Raster (z. B. 24+48 → 24 cm). Sonst 8-cm-Raster (`STUDIO_MASONRY`). Abstand zwischen Öffnungen 32 cm; kein Pflicht-Randabstand zur Wandkante |
