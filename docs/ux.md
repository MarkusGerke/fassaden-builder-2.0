...
| Fenster/Tür (ganz) | **Fenster/Tür/Ausschnitt kopieren**, **Stil kopieren** (v2.0.223, flach ohne Untermenü), **Markise kopieren** (wenn aktiv, v2.0.429), **Markise einfügen/ersetzen** (eigene Markisen-Zwischenablage), **Eine Markise über Auswahl** (≥2 Öffnungen derselben Wand, v2.0.430), **Öffnung einfügen**, Duplizieren nach links / rechts, **Ersetzen durch** (`WALL_OPENING_PRESETS`, alle ausgewählten, mittelaxial), **Stile einfügen…** (Öffnungsstile aus der Zwischenablage), Löschen |
