...
- **Gleiten (v2.0.229):** Verschieben rastet in **24-cm-Schritten** (`BAY_SLIDE_STEP_CM`); Reststücke bleiben ≥ 8 cm. Erker anderer Etagen mit gleichem Mund (Etagen-Stapel aus „Als Segment“) gleiten **mit**. Während des Ziehens werden Reststücke live neu gebaut — keine Lücken zwischen Erker und Nachbarwand.
