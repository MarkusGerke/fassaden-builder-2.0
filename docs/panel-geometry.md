...
**Öffnungen an Fugen (v2.0.66–v2.0.67):** `masonryPatternCuts` (Cuts ohne Öffnungs-Blocker) + `openingPanelSnap.ts` — Drag/Nudge/Maße snappen Laibungen an echte Vertikalfugen (Union gerade/versetzte Lage) und Unterkante an Schichtgrenzen. **v2.0.67:** Gestapelte Etagen mit verschiedenem Modul → gemeinsames **LCM**-Raster der Modul-Einheiten (24er+48er → 24 cm), damit Öffnungen auf beiden Geschossen einpassbar bleiben; Verband unverändert. Streifen/Wild/none bleiben am 8-cm-Raster.
