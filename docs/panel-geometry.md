...
**Öffnungen an Fugen (v2.0.66–v2.0.69):** `openingPanelSnap.ts` — Kandidaten **Fuge**, **Steinmitte**, **Wandmitte**. **Schichten (v2.0.70):** [facade-layers.md](facade-layers.md) — Freiraum nur Verkleidung, Einbettung ohne Shell-Loch.
