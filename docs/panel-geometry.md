...
**Öffnungen an Fugen (v2.0.66):** `masonryPatternCuts` (Cuts ohne Öffnungs-Blocker) + `openingPanelSnap.ts` — Drag/Nudge/Maße snappen Laibungen an echte Vertikalfugen (Union gerade/versetzte Lage) und Unterkante an Schichtgrenzen. Verband-Pipeline unverändert; Streifen/Wild/none bleiben am 8-cm-Raster.
