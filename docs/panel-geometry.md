...
**Öffnungen an Fugen (v2.0.66–v2.0.69):** `openingPanelSnap.ts` — Kandidaten **Fuge** (Laibung auf Cut), **Steinmitte** (Fenstermitte), **Wandmitte** (auch 45°). Drag = nächster Absolut-Kandidat; Nudge = nächster/vorheriger. **v2.0.68:** Läufer-Rest nur am Ende. Streifen/Wild/none: 8-cm-Raster.
