...
- **Schattenseiten Hauptfläche (v2.0.57 / v2.0.312):** `dimMask = 1 − sideOrTop` — bei Gegenlicht werden große Wandflächen abgedunkelt; Seiten/Oberkanten der Geometrie bleiben hell. **v2.0.312:** `hemiDim` hoch (~0,55…0,94) — Ambient bleibt auf Gegenlicht-Flächen weitgehend erhalten (sonst Erker-Schenkel pechschwarzer als Schlagschatten auf der Nachbarwand). Direct weiter stark gedimmt. Datei: `facadeShade.ts`.
