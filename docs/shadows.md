...
- **Schattenseiten Hauptfläche (v2.0.57 / v2.0.312 / v2.0.371 / v2.0.428):** Gegenlicht dimmt die große Wandfront (`dimMask`, Seiten bleiben heller). **v2.0.413–418** edgeShade/wallUnlit/Glas-Env — **v2.0.428 zurück** (zu grau). Dateien: `facadeShade.ts`, `threeColors.ts`, `main.ts`.
