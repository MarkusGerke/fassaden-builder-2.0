...
- **Schattenseiten Hauptfläche (v2.0.57 / v2.0.312 / v2.0.371 / v2.0.428 / v2.0.589):** Gegenlicht dimmt die große Wandfront (`dimMask`). **v2.0.589:** `dimMask = 1.0` (kein `sideOrTop×0,82`) — horizontale Tops (Bank/Gesims/Sockel/Treppe) dimmen voll mit; Cache `facade-backlit-v23`. **v2.0.413–418** edgeShade/wallUnlit/Glas-Env — **v2.0.428 zurück** (zu grau). Dateien: `facadeShade.ts`, `threeColors.ts`, `main.ts`.
