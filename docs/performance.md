...
- **Blaulicht (v2.0.335):** Blitzdauer skaliert mit geglätteter Frame-Zeit (`blaulichtFlashDurationMs`) — bei niedriger FPS sichtbar statt zwischen Frames verloren. `stableLightCount` nur bei Blaulicht-Blinken oder Licht-Modus (nicht für jedes statische Licht).
