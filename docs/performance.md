...
- **Orbit-Lite (v2.0.100 / v2.0.124 / v2.0.125 / v2.0.151 / v2.0.170 / v2.0.172):** Bei **jeder** Kamerageste: EnvMap-Bake pausiert; Gizmo-Update im Loop pausiert. **Pixelratio:** standardmäßig 1 während der Geste; **Ausnahme:** Bloom an und „bei Bewegung aus“ nicht gesetzt → volle Pixelratio. **Bloom:** bleibt standardmäßig **an** beim Orbit — Szene direkt auf den Canvas, Bloom additiv. Hold `ORBIT_LITE_HOLD_MS` (320 ms).
