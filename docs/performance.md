...
- **Licht-only (v2.0.141):** Hinzufügen/Ausblenden/Löschen von Bibliotheks-Lichtern kein Fassaden-Rebuild mehr (`stabilizeFloorPlanIds` + Licht-Schnellpfad in `applyState`). Nur Punktlicht-Shadows, kein Sonnen-/EnvMap-Bake; Okcluder nur bei Okklusion-Toggle.
