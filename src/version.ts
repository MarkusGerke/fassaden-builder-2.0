...
export const APP_VERSION = '2.0.551'
...
export const RELEASES: ReleaseNote[] = [
  ...
  },
  {
    version: '2.0.375',
    date: '2026-09-11',
    title: 'Rechte Einstellungen einklappbar',
    changes: [
      'Rechte Spalte (Einstellungen) lässt sich wie die Ebenen links ein- und ausklappen',
    ],
  },
  {
    version: '2.0.374',
    date: '2026-09-11',
    title: 'Deploy nur geänderte Dateien',
    changes: [
      'All-Inkl-Deploy lädt nicht mehr jedes Mal alles neu (Fonts bleiben, wenn unverändert)',
    ],
  },
  {
    version: '2.0.373',
  ...
  },
  {
    version: '2.0.325',
    date: '2026-09-09',
    title: 'Steingrau-Boden und Pfützen',
    changes: [
      'Boden ist dauerhaft steingrau (#7E848C)',
      'Szene → Pfützen: nasse Spiegelstellen spiegeln die Fassade (3D; während Orbit aus)',
    ],
  },
  {
    version: '2.0.324',
  ...
  },
  {
    version: '2.0.263',
    date: '2026-09-06',
    title: 'Kein Licht durch den Erkerboden',
    changes: [
      'Unter dem Erker bleibt die Wand im Schatten — Sonne scheint nicht mehr durch den Erkerboden',
    ],
  },
  {
    version: '2.0.262',
    date: '2026-09-06',
    title: 'Orbit mit Bloom flüssiger',
    changes: [
      'Mit Bloom an bleibt beim Drehen/Zoomen die leichtere Orbit-Auflösung (1,5×) — stockt nicht mehr wie bei voller 2×',
      'Bloom bleibt während der Navigation sichtbar; das Glühen kann dabei etwas weicher wirken',
    ],
  },
  {
    version: '2.0.261',
