...
describe('facadeShade', () => {
  ...
  it('hängt den Gegenlicht-Shader an Standard-Material', () => {
    ...
    expect(shader.fragmentShader).toContain('// v2.0.590')
    expect(shader.fragmentShader).toContain('upFacing')
    expect(shader.fragmentShader).toContain('downFacing')
    expect(shader.fragmentShader).toContain('wallBacklit')
  ...
  it('Normalen-Modus für Rahmen: Uniform 1, Shader nutzt geometryNormal (v2.0.365)', () => {
    ...
    expect(shader.fragmentShader).toContain('uNormalBacklit')
    expect(shader.fragmentShader).toContain('normalAmt')
